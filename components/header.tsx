...
const Header: React.FC = () => (
  <header className="bg-gray-900 sm:h-20 py-5 sm:sticky top-0">
      ...
      <div className="w-full flex flex-col sm:flex-row justify-center sm:justify-between items-center">
        <div className="flex flex-col sm:flex-row items-center mb-4 sm:mb-0">
          ...
          <div className="sm:ml-8 flex space-x-5 text-center">
            <Link href="/">
              <a className="text-gray-200 hover:text-pink-700">Home</a>
            </Link>
            <Link href="/about-us">
              <a className="text-gray-200 hover:text-pink-700">About us</a>
            </Link>
            <Link href="/blog">
              <a className="text-gray-200 hover:text-pink-700">Blog</a>
            </Link>
          </div>
        </div>
